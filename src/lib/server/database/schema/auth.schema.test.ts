...
test("existing numeric credential accounts can sign in and create a session", async () => {
    ...
    try {
        sqlite.exec(await Bun.file(new URL("../../../../../drizzle/0000_overrated_adam_warlock.sql", import.meta.url)).text());
        ...
        sqlite.exec(await Bun.file(new URL("../../../../../drizzle/0002_credential_account_id_text.sql", import.meta.url)).text());
