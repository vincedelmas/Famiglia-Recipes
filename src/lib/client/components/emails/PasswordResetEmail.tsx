...
export const PasswordResetEmail = ({ username, link, brand = "Famiglia-Recipes" }: PasswordResetEmailProps) => {
                ...
                <Body className="bg-white my-auto mx-auto font-sans">
                    <Container className="border border-solid border-[#eaeaea] rounded my-10 mx-auto p-5 max-w-116.25">
                        ...
                        <Text className="text-black text-[14px] leading-6">
                            We received a request to reset your password for your {brand} account. If you didn't make this
                            request, you can safely ignore this email.
                        </Text>
                        <Section className="text-center my-8">
                            <Button
                                href={link}
                                className="bg-[#000000] rounded text-white text-[12px] font-semibold no-underline
                                text-center px-5 py-3 inline-block cursor-pointer"
                            >
                                Reset Password
                            </Button>
                        </Section>
