import {Tailwind, Body, Button, Container, Head, Heading, Html, Link, Preview, Section, Text} from "@react-email/components";
...
export const RegisterEmail = ({ username, link, brand = "Famiglia-Recipes" }: RegisterEmailProps) => {
