...
const badgeVariants = cva("group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden " +
    ...
    variants: {
        variant: {
            inactive: "bg-primary text-primary-foreground shadow rounded-full",
...
function Badge({ className, variant = "default", render, color, ...props }: useRender.ComponentProps<"span">
